...
def set_arguments(args):
    ...
    args.pretrain_dir = os.path.join("pretrained_buffers", f'{args.dataset}_{args.noise_type}_{args.noise_rate}')
    ...
    if args.test:
        ...
        args.save_dir = os.path.join("results",f'{args.dataset}_ipc{args.ipc}_{args.noise_type}_{args.noise_rate}')
