...
class ValueEstimator(nn.Module):
    ...
    def __init__(self, feat_num, num_classes, hidden_num, layer_num, comb_dim):
        """
        Construct class
        :param hidden_num:
        :type hidden_num:
        ...
        layers = []
        # input_dim+label_dim
        # layers.append(nn.Linear(2049, hidden_num))  # raw
        layers.append(nn.Linear(feat_num + num_classes, hidden_num))
